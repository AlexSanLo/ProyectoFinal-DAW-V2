 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const hl=new Vh("@firebase/auth");function MS(n,...e){hl.logLevel<=_e.WARN&&hl.warn(`Auth (${di}): ${n}`,...e)}function La(n,...e){hl.logLevel<=_e.ERROR&&hl.error(`Auth (${di}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xy(n,e,t=!1){if($t(n.app))return Promise.reject(Vn(n));const r="signIn",s=await Yy(n,r,e),i=await is._fromIdTokenResponse(n,r,s);return t||await n._updateCurrentUser(i.user),i}async function VR(n,e){return Xy(Er(n),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Zy(n){const e=Er(n);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function DR(n,e,t){const r=Er(n);await ml(r,{requestType:"PASSWORD_RESET",email:e,clientType:"CLIENT_TYPE_WEB"},"getOobCode",ER)}async function NR(n,e,t){if($t(n.app))return Promise.reject(Vn(n));const r=Er(n),o=await ml(r,{returnSecureToken:!0,email:e,password:t,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",CR).catch(c=>{throw c.code==="auth/password-does-not-meet-requirements"&&Zy(n),c}),l=await is._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(l.user),l}function OR(n,e,t){return $t(n.app)?Promise.reject(Vn(n)):VR($e(n),fi.credential(e,t)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&Zy(n),r})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const os=new Vh("@firebase/firestore");function xs(){return os.logLevel}function $(n,...e){if(os.logLevel<=_e.DEBUG){const t=e.map(Yh);os.debug(`Firestore (${pi}): ${n}`,...t)}}function Et(n,...e){if(os.logLevel<=_e.ERROR){const t=e.map(Yh);os.error(`Firestore (${pi}): ${n}`,...t)}}function Io(n,...e){if(os.logLevel<=_e.WARN){const t=e.map(Yh);os.warn(`Firestore (${pi}): ${n}`,...t)}}function Yh(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Jr=-1;function nc(n){return n==null}function bo(n){return n===0&&1/n==-1/0}function pC(n){return typeof n=="number"&&Number.isInteger(n)&&!bo(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Br="remoteDocuments",Ko="owner",Ts="owner",Ao="mutationQueues",gC="userId",Wt="mutations",pm="batchId",Gr="userMutationsIndex",mm=["userId","batchId"];/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
