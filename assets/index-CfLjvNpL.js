 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class t1{constructor(){this.sessionToken=Ge.EMPTY_BYTE_STRING}getSessionToken(e){return C.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,C.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function b1(){return typeof window<"u"?window:null}function Za(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fs="RemoteStore";class x1{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.ha=[],this.Pa=new Map,this.Ta=new Set,this.Ia=[],this.Ea=i,this.Ea.No(o=>{r.enqueueAndForget(async()=>{gs(this)&&($(fs,"Restarting streams for network reachability change."),await async function(c){const u=he(c);u.Ta.add(4),await Xo(u),u.da.set("Unknown"),u.Ta.delete(4),await vc(u)}(this))})}),this.da=new C1(r,s)}}async function vc(n){if(gs(n))for(const e of n.Ia)await e(!0)}async function Xo(n){for(const e of n.Ia)await e(!1)}function tI(n,e){const t=he(n);t.Pa.has(e.targetId)||(t.Pa.set(e.targetId,e),kd(t)?xd(t):yi(t).M_()&&Cd(t,e))}function Pd(n,e){const t=he(n),r=yi(t);t.Pa.delete(e),r.M_()&&nI(t,e),t.Pa.size===0&&(r.M_()?r.N_():gs(t)&&t.da.set("Unknown"))}function Cd(n,e){if(n.Aa.Ke(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(se.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}yi(n).H_(e)}function nI(n,e){n.Aa.Ke(e),yi(n).J_(e)}function xd(n){n.Aa=new Tx({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Rt:e=>n.Pa.get(e)||null,Pt:()=>n.datastore.serializer.databaseId}),yi(n).start(),n.da._a()}function kd(n){return gs(n)&&!yi(n).F_()&&n.Pa.size>0}function gs(n){return he(n).Ta.size===0}function rI(n){n.Aa=void 0}async function k1(n){n.da.set("Online")}async function V1(n){n.Pa.forEach((e,t)=>{Cd(n,e)})}async function D1(n,e){rI(n),kd(n)?(n.da.ca(e),xd(n)):n.da.set("Unknown")}async function N1(n,e,t){if(n.da.set("Online"),e instanceof Iw&&e.state===2&&e.cause)try{await async function(s,i){const o=i.cause;for(const l of i.targetIds)s.Pa.has(l)&&(await s.remoteSyncer.rejectListen(l,o),s.Pa.delete(l),s.Aa.removeTarget(l))}(n,e)}catch(r){$(fs,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Ol(n,r)}else if(e instanceof Ya?n.Aa.Xe(e):e instanceof ww?n.Aa.ot(e):n.Aa.nt(e),!t.isEqual(se.min()))try{const r=await Yw(n.localStore);t.compareTo(r)>=0&&await function(i,o){const l=i.Aa.It(o);return l.targetChanges.forEach((c,u)=>{if(c.resumeToken.approximateByteSize()>0){const d=i.Pa.get(u);d&&i.Pa.set(u,d.withResumeToken(c.resumeToken,o))}}),l.targetMismatches.forEach((c,u)=>{const d=i.Pa.get(c);if(!d)return;i.Pa.set(c,d.withResumeToken(Ge.EMPTY_BYTE_STRING,d.snapshotVersion)),nI(i,c);const p=new xn(d.target,c,u,d.sequenceNumber);Cd(i,p)}),i.remoteSyncer.applyRemoteEvent(l)}(n,t)}catch(r){$(fs,"Failed to raise snapshot:",r),await Ol(n,r)}}async function Ol(n,e,t){if(!Ar(e))throw e;n.Ta.add(1),await Xo(n),n.da.set("Offline"),t||(t=()=>Yw(n.localStore)),n.asyncQueue.enqueueRetryable(async()=>{$(fs,"Retrying IndexedDB access"),await t(),n.Ta.delete(1),await vc(n)})}function sI(n,e){return e().catch(t=>Ol(n,t,e))}async function Zo(n){const e=he(n),t=Ir(e);let r=e.ha.length>0?e.ha[e.ha.length-1].batchId:Xr;for(;O1(e);)try{const s=await g1(e.localStore,r);if(s===null){e.ha.length===0&&t.N_();break}r=s.batchId,M1(e,s)}catch(s){await Ol(e,s)}iI(e)&&oI(e)}function O1(n){return gs(n)&&n.ha.length<10}function M1(n,e){n.ha.push(e);const t=Ir(n);t.M_()&&t.Y_&&t.Z_(e.mutations)}function iI(n){return gs(n)&&!Ir(n).F_()&&n.ha.length>0}function oI(n){Ir(n).start()}async function L1(n){Ir(n).ta()}async function F1(n){const e=Ir(n);for(const t of n.ha)e.Z_(t.mutations)}async function U1(n,e,t){const r=n.ha.shift(),s=_d.from(r,e,t);await sI(n,()=>n.remoteSyncer.applySuccessfulWrite(s)),await Zo(n)}async function B1(n,e){e&&Ir(n).Y_&&await async function(r,s){if(function(o){return wx(o)&&o!==O.ABORTED}(s.code)){const i=r.ha.shift();Ir(r).O_(),await sI(r,()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s)),await Zo(r)}}(n,e),iI(n)&&oI(n)}async function _g(n,e){const t=he(n);t.asyncQueue.verifyOperationInProgress(),$(fs,"RemoteStore received new credentials");const r=gs(t);t.Ta.add(3),await Xo(t),r&&t.da.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ta.delete(3),await vc(t)}async function $1(n,e){const t=he(n);e?(t.Ta.delete(2),await vc(t)):e||(t.Ta.add(2),await Xo(t),t.da.set("Unknown"))}function yi(n){return n.Ra||(n.Ra=function(t,r,s){const i=he(t);return i.ra(),new A1(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{e_:k1.bind(null,n),n_:V1.bind(null,n),i_:D1.bind(null,n),j_:N1.bind(null,n)}),n.Ia.push(async e=>{e?(n.Ra.O_(),kd(n)?xd(n):n.da.set("Unknown")):(await n.Ra.stop(),rI(n))})),n.Ra}function Ir(n){return n.Va||(n.Va=function(t,r,s){const i=he(t);return i.ra(),new S1(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)}(n.datastore,n.asyncQueue,{e_:()=>Promise.resolve(),n_:L1.bind(null,n),i_:B1.bind(null,n),X_:F1.bind(null,n),ea:U1.bind(null,n)}),n.Ia.push(async e=>{e?(n.Va.O_(),await Zo(n)):(await n.Va.stop(),n.ha.length>0&&($(fs,`Stopping write stream with ${n.ha.length} pending writes`),n.ha=[]))})),n.Va}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class j1{constructor(){this.pa=void 0,this.ya=[]}wa(){return this.ya.some(e=>e.Sa())}}class q1{constructor(){this.queries=vg(),this.onlineState="Unknown",this.ba=new Set}terminate(){(function(t,r){const s=he(t),i=s.queries;s.queries=vg(),i.forEach((o,l)=>{for(const c of l.ya)c.onError(r)})})(this,new Y(O.ABORTED,"Firestore shutting down"))}}function vg(){return new jn(n=>ow(n),uc)}async function K1(n,e){const t=he(n);let r=3;const s=e.query;let i=t.queries.get(s);i?!i.wa()&&e.Sa()&&(r=2):(i=new j1,r=e.Sa()?0:1);try{switch(r){case 0:i.pa=await t.onListen(s,!0);break;case 1:i.pa=await t.onListen(s,!1);break;case 2:await t.onFirstRemoteStoreListen(s)}}catch(o){const l=Dd(o,`Initialization of query '${Vs(e.query)}' failed`);return void e.onError(l)}t.queries.set(s,i),i.ya.push(e),e.Da(t.onlineState),i.pa&&e.va(i.pa)&&Nd(t)}async function z1(n,e){const t=he(n),r=e.query;let s=3;const i=t.queries.get(r);if(i){const o=i.ya.indexOf(e);o>=0&&(i.ya.splice(o,1),i.ya.length===0?s=e.Sa()?0:1:!i.wa()&&e.Sa()&&(s=2))}switch(s){case 0:return t.queries.delete(r),t.onUnlisten(r,!0);case 1:return t.queries.delete(r),t.onUnlisten(r,!1);case 2:return t.onLastRemoteStoreUnlisten(r);default:return}}function H1(n,e){const t=he(n);let r=!1;for(const s of e){const i=s.query,o=t.queries.get(i);if(o){for(const l of o.ya)l.va(s)&&(r=!0);o.pa=s}}r&&Nd(t)}function G1(n,e,t){const r=he(n),s=r.queries.get(e);if(s)for(const i of s.ya)i.onError(t);r.queries.delete(e)}function Nd(n){n.ba.forEach(e=>{e.next()})}var ch,wg;(wg=ch||(ch={})).Ca="default",wg.Cache="cache";class W1{constructor(e,t,r){this.query=e,this.Fa=t,this.Ma=!1,this.xa=null,this.onlineState="Unknown",this.options=r||{}}va(e){if(!this.options.includeMetadataChanges){const r=[];for(const s of e.docChanges)s.type!==3&&r.push(s);e=new ui(e.query,e.docs,e.oldDocs,r,e.mutatedKeys,e.fromCache,e.syncStateChanged,!0,e.hasCachedResults)}let t=!1;return this.Ma?this.Oa(e)&&(this.Fa.next(e),t=!0):this.Na(e,this.onlineState)&&(this.Ba(e),t=!0),this.xa=e,t}onError(e){this.Fa.error(e)}Da(e){this.onlineState=e;let t=!1;return this.xa&&!this.Ma&&this.Na(this.xa,e)&&(this.Ba(this.xa),t=!0),t}Na(e,t){if(!e.fromCache||!this.Sa())return!0;const r=t!=="Offline";return(!this.options.La||!r)&&(!e.docs.isEmpty()||e.hasCachedResults||t==="Offline")}Oa(e){if(e.docChanges.length>0)return!0;const t=this.xa&&this.xa.hasPendingWrites!==e.hasPendingWrites;return!(!e.syncStateChanged&&!t)&&this.options.includeMetadataChanges===!0}Ba(e){e=ui.fromInitialDocuments(e.query,e.docs,e.mutatedKeys,e.fromCache,e.hasCachedResults),this.Ma=!0,this.Fa.next(e)}Sa(){return this.options.source!==ch.Cache}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class aI{constructor(e){this.key=e}}class lI{constructor(e){this.key=e}}class Q1{constructor(e,t){this.query=e,this.Ga=t,this.za=null,this.hasCachedResults=!1,this.current=!1,this.ja=ge(),this.mutatedKeys=ge(),this.Ha=aw(e),this.Ja=new Qs(this.Ha)}get Ya(){return this.Ga}Za(e,t){const r=t?t.Xa:new yg,s=t?t.Ja:this.Ja;let i=t?t.mutatedKeys:this.mutatedKeys,o=s,l=!1;const c=this.query.limitType==="F"&&s.size===this.query.limit?s.last():null,u=this.query.limitType==="L"&&s.size===this.query.limit?s.first():null;if(e.inorderTraversal((d,p)=>{const m=s.get(d),w=Jo(this.query,p)?p:null,P=!!m&&this.mutatedKeys.has(m.key),k=!!w&&(w.hasLocalMutations||this.mutatedKeys.has(w.key)&&w.hasCommittedMutations);let R=!1;m&&w?m.data.isEqual(w.data)?P!==k&&(r.track({type:3,doc:w}),R=!0):this.eu(m,w)||(r.track({type:2,doc:w}),R=!0,(c&&this.Ha(w,c)>0||u&&this.Ha(w,u)<0)&&(l=!0)):!m&&w?(r.track({type:0,doc:w}),R=!0):m&&!w&&(r.track({type:1,doc:m}),R=!0,(c||u)&&(l=!0)),R&&(w?(o=o.add(w),i=k?i.add(d):i.delete(d)):(o=o.delete(d),i=i.delete(d)))}),this.query.limit!==null)for(;o.size>this.query.limit;){const d=this.query.limitType==="F"?o.last():o.first();o=o.delete(d.key),i=i.delete(d.key),r.track({type:1,doc:d})}return{Ja:o,Xa:r,Cs:l,mutatedKeys:i}}eu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,s){const i=this.Ja;this.Ja=e.Ja,this.mutatedKeys=e.mutatedKeys;const o=e.Xa.ga();o.sort((d,p)=>function(w,P){const k=R=>{switch(R){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return X(20277,{Vt:R})}};return k(w)-k(P)}(d.type,p.type)||this.Ha(d.doc,p.doc)),this.tu(r),s=s!=null&&s;const l=t&&!s?this.nu():[],c=this.ja.size===0&&this.current&&!s?1:0,u=c!==this.za;return this.za=c,o.length!==0||u?{snapshot:new ui(this.query,e.Ja,i,o,e.mutatedKeys,c===0,u,!1,!!r&&r.resumeToken.approximateByteSize()>0),ru:l}:{ru:l}}Da(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({Ja:this.Ja,Xa:new yg,mutatedKeys:this.mutatedKeys,Cs:!1},!1)):{ru:[]}}iu(e){return!this.Ga.has(e)&&!!this.Ja.has(e)&&!this.Ja.get(e).hasLocalMutations}tu(e){e&&(e.addedDocuments.forEach(t=>this.Ga=this.Ga.add(t)),e.modifiedDocuments.forEach(t=>{}),e.removedDocuments.forEach(t=>this.Ga=this.Ga.delete(t)),this.current=e.current)}nu(){if(!this.current)return[];const e=this.ja;this.ja=ge(),this.Ja.forEach(r=>{this.iu(r.key)&&(this.ja=this.ja.add(r.key))});const t=[];return e.forEach(r=>{this.ja.has(r)||t.push(new lI(r))}),this.ja.forEach(r=>{e.has(r)||t.push(new aI(r))}),t}su(e){this.Ga=e.$s,this.ja=ge();const t=this.Za(e.documents);return this.applyChanges(t,!0)}ou(){return ui.fromInitialDocuments(this.query,this.Ja,this.mutatedKeys,this.za===0,this.hasCachedResults)}}const Od="SyncEngine";class J1{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class Y1{constructor(e){this.key=e,this._u=!1}}class X1{constructor(e,t,r,s,i,o){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=s,this.currentUser=i,this.maxConcurrentLimboResolutions=o,this.au={},this.uu=new jn(l=>ow(l),uc),this.cu=new Map,this.lu=new Set,this.hu=new Fe(Q.comparator),this.Pu=new Map,this.Tu=new Ed,this.Iu={},this.Eu=new Map,this.du=ds.lr(),this.onlineState="Unknown",this.Au=void 0}get isPrimaryClient(){return this.Au===!0}}async function Z1(n,e,t=!0){const r=pI(n);let s;const i=r.uu.get(e);return i?(r.sharedClientState.addLocalQueryTarget(i.targetId),s=i.view.ou()):s=await cI(r,e,t,!0),s}async function ek(n,e){const t=pI(n);await cI(t,e,!0,!1)}async function cI(n,e,t,r){const s=await _1(n.localStore,zt(e)),i=s.targetId,o=n.sharedClientState.addLocalQueryTarget(i,t);let l;return r&&(l=await tk(n,e,i,o==="current",s.resumeToken)),n.isPrimaryClient&&t&&tI(n.remoteStore,s),l}async function tk(n,e,t,r,s){n.Ru=(p,m,w)=>async function(k,R,N,j){let K=R.view.Za(N);K.Cs&&(K=await dg(k.localStore,R.query,!1).then(({documents:b})=>R.view.Za(b,K)));const q=j&&j.targetChanges.get(R.targetId),Z=j&&j.targetMismatches.get(R.targetId)!=null,ee=R.view.applyChanges(K,k.isPrimaryClient,q,Z);return Tg(k,R.targetId,ee.ru),ee.snapshot}(n,p,m,w);const i=await dg(n.localStore,e,!0),o=new Q1(e,i.$s),l=o.Za(i.documents),c=Yo.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",s),u=o.applyChanges(l,n.isPrimaryClient,c);Tg(n,t,u.ru);const d=new J1(e,t,o);return n.uu.set(e,d),n.cu.has(t)?n.cu.get(t).push(e):n.cu.set(t,[e]),u.snapshot}async function nk(n,e,t){const r=he(n),s=r.uu.get(e),i=r.cu.get(s.targetId);if(i.length>1)return r.cu.set(s.targetId,i.filter(o=>!uc(o,e))),void r.uu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(s.targetId),r.sharedClientState.isActiveQueryTarget(s.targetId)||await ah(r.localStore,s.targetId,!1).then(()=>{r.sharedClientState.clearQueryState(s.targetId),t&&Pd(r.remoteStore,s.targetId),uh(r,s.targetId)}).catch(ms)):(uh(r,s.targetId),await ah(r.localStore,s.targetId,!0))}async function rk(n,e){const t=he(n),r=t.uu.get(e),s=t.cu.get(r.targetId);t.isPrimaryClient&&s.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),Pd(t.remoteStore,r.targetId))}async function sk(n,e,t){const r=mI(n);try{const s=await function(o,l){const c=he(o),u=Be.now(),d=l.reduce((w,P)=>w.add(P.key),ge());let p,m;return c.persistence.runTransaction("Locally write mutations","readwrite",w=>{let P=Ot(),k=ge();return c.Bs.getEntries(w,d).next(R=>{P=R,P.forEach((N,j)=>{j.isValidDocument()||(k=k.add(N))})}).next(()=>c.localDocuments.getOverlayedDocuments(w,P)).next(R=>{p=R;const N=[];for(const j of l){const K=yx(j,p.get(j.key).overlayedDocument);K!=null&&N.push(new qn(j.key,K,Yv(K.value.mapValue),Et.exists(!0)))}return c.mutationQueue.addMutationBatch(w,u,N,l)}).next(R=>{m=R;const N=R.applyToLocalDocumentSet(p,k);return c.documentOverlayCache.saveOverlays(w,R.batchId,N)})}).then(()=>({batchId:m.batchId,changes:cw(p)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(s.batchId),function(o,l,c){let u=o.Iu[o.currentUser.toKey()];u||(u=new Fe(ue)),u=u.insert(l,c),o.Iu[o.currentUser.toKey()]=u}(r,s.batchId,t),await ea(r,s.changes),await Zo(r.remoteStore)}catch(s){const i=Dd(s,"Failed to persist write");t.reject(i)}}async function uI(n,e){const t=he(n);try{const r=await p1(t.localStore,e);e.targetChanges.forEach((s,i)=>{const o=t.Pu.get(i);o&&(ne(s.addedDocuments.size+s.modifiedDocuments.size+s.removedDocuments.size<=1,22616),s.addedDocuments.size>0?o._u=!0:s.modifiedDocuments.size>0?ne(o._u,14607):s.removedDocuments.size>0&&(ne(o._u,42227),o._u=!1))}),await ea(t,r,e)}catch(r){await ms(r)}}function Ig(n,e,t){const r=he(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const s=[];r.uu.forEach((i,o)=>{const l=o.view.Da(e);l.snapshot&&s.push(l.snapshot)}),function(o,l){const c=he(o);c.onlineState=l;let u=!1;c.queries.forEach((d,p)=>{for(const m of p.ya)m.Da(l)&&(u=!0)}),u&&Nd(c)}(r.eventManager,e),s.length&&r.au.j_(s),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function ik(n,e,t){const r=he(n);r.sharedClientState.updateQueryState(e,"rejected",t);const s=r.Pu.get(e),i=s&&s.key;if(i){let o=new Fe(Q.comparator);o=o.insert(i,je.newNoDocument(i,se.min()));const l=ge().add(i),c=new pc(se.min(),new Map,new Fe(ue),o,l);await uI(r,c),r.hu=r.hu.remove(i),r.Pu.delete(e),Md(r)}else await ah(r.localStore,e,!1).then(()=>uh(r,e,t)).catch(ms)}async function ok(n,e){const t=he(n),r=e.batch.batchId;try{const s=await f1(t.localStore,e);dI(t,r,null),hI(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await ea(t,s)}catch(s){await ms(s)}}async function ak(n,e,t){const r=he(n);try{const s=await function(o,l){const c=he(o);return c.persistence.runTransaction("Reject batch","readwrite-primary",u=>{let d;return c.mutationQueue.lookupMutationBatch(u,l).next(p=>(ne(p!==null,37113),d=p.keys(),c.mutationQueue.removeMutationBatch(u,p))).next(()=>c.mutationQueue.performConsistencyCheck(u)).next(()=>c.documentOverlayCache.removeOverlaysForBatchId(u,d,l)).next(()=>c.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(u,d)).next(()=>c.localDocuments.getDocuments(u,d))})}(r.localStore,e);dI(r,e,t),hI(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await ea(r,s)}catch(s){await ms(s)}}function hI(n,e){(n.Eu.get(e)||[]).forEach(t=>{t.resolve()}),n.Eu.delete(e)}function dI(n,e,t){const r=he(n);let s=r.Iu[r.currentUser.toKey()];if(s){const i=s.get(e);i&&(t?i.reject(t):i.resolve(),s=s.remove(e)),r.Iu[r.currentUser.toKey()]=s}}function uh(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.cu.get(e))n.uu.delete(r),t&&n.au.Vu(r,t);n.cu.delete(e),n.isPrimaryClient&&n.Tu.Hr(e).forEach(r=>{n.Tu.containsKey(r)||fI(n,r)})}function fI(n,e){n.lu.delete(e.path.canonicalString());const t=n.hu.get(e);t!==null&&(Pd(n.remoteStore,t),n.hu=n.hu.remove(e),n.Pu.delete(t),Md(n))}function Tg(n,e,t){for(const r of t)r instanceof aI?(n.Tu.addReference(r.key,e),lk(n,r)):r instanceof lI?($(Od,"Document no longer in limbo: "+r.key),n.Tu.removeReference(r.key,e),n.Tu.containsKey(r.key)||fI(n,r.key)):X(19791,{mu:r})}function lk(n,e){const t=e.key,r=t.path.canonicalString();n.hu.get(t)||n.lu.has(r)||($(Od,"New document in limbo: "+t),n.lu.add(r),Md(n))}function Md(n){for(;n.lu.size>0&&n.hu.size<n.maxConcurrentLimboResolutions;){const e=n.lu.values().next().value;n.lu.delete(e);const t=new Q(Re.fromString(e)),r=n.du.next();n.Pu.set(r,new Y1(t)),n.hu=n.hu.insert(t,r),tI(n.remoteStore,new xn(zt(pd(t.path)),r,"TargetPurposeLimboResolution",jt.le))}}async function ea(n,e,t){const r=he(n),s=[],i=[],o=[];r.uu.isEmpty()||(r.uu.forEach((l,c)=>{o.push(r.Ru(c,e,t).then(u=>{var d;if((u||t)&&r.isPrimaryClient){const p=u?!u.fromCache:(d=t==null?void 0:t.targetChanges.get(c.targetId))===null||d===void 0?void 0:d.current;r.sharedClientState.updateQueryState(c.targetId,p?"current":"not-current")}if(u){s.push(u);const p=Sd.Rs(c.targetId,u);i.push(p)}}))}),await Promise.all(o),r.au.j_(s),await async function(c,u){const d=he(c);try{await d.persistence.runTransaction("notifyLocalViewChanges","readwrite",p=>C.forEach(u,m=>C.forEach(m.ds,w=>d.persistence.referenceDelegate.addReference(p,m.targetId,w)).next(()=>C.forEach(m.As,w=>d.persistence.referenceDelegate.removeReference(p,m.targetId,w)))))}catch(p){if(!Ar(p))throw p;$(Rd,"Failed to update sequence numbers: "+p)}for(const p of u){const m=p.targetId;if(!p.fromCache){const w=d.xs.get(m),P=w.snapshotVersion,k=w.withLastLimboFreeSnapshotVersion(P);d.xs=d.xs.insert(m,k)}}}(r.localStore,i))}async function ck(n,e){const t=he(n);if(!t.currentUser.isEqual(e)){$(Od,"User change. New user:",e.toKey());const r=await Jw(t.localStore,e);t.currentUser=e,function(i,o){i.Eu.forEach(l=>{l.forEach(c=>{c.reject(new Y(O.CANCELLED,o))})}),i.Eu.clear()}(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await ea(t,r.ks)}}function uk(n,e){const t=he(n),r=t.Pu.get(e);if(r&&r._u)return ge().add(r.key);{let s=ge();const i=t.cu.get(e);if(!i)return s;for(const o of i){const l=t.uu.get(o);s=s.unionWith(l.view.Ya)}return s}}function pI(n){const e=he(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=uI.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=uk.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=ik.bind(null,e),e.au.j_=H1.bind(null,e.eventManager),e.au.Vu=G1.bind(null,e.eventManager),e}function mI(n){const e=he(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=ok.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=ak.bind(null,e),e}class Lo{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=yc(e.databaseInfo.databaseId),this.sharedClientState=this.pu(e),this.persistence=this.yu(e),await this.persistence.start(),this.localStore=this.wu(e),this.gcScheduler=this.Su(e,this.localStore),this.indexBackfillerScheduler=this.bu(e,this.localStore)}Su(e,t){return null}bu(e,t){return null}wu(e){return Qw(this.persistence,new Ww,e.initialUser,this.serializer)}yu(e){return new bd(_c.fi,this.serializer)}pu(e){return new Xw}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}Lo.provider={build:()=>new Lo};class hk extends Lo{constructor(e){super(),this.cacheSizeBytes=e}Su(e,t){ne(this.persistence.referenceDelegate instanceof Nl,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new qw(r,e.asyncQueue,t)}yu(e){const t=this.cacheSizeBytes!==void 0?ht.withCacheSize(this.cacheSizeBytes):ht.DEFAULT;return new bd(r=>Nl.fi(r,t),this.serializer)}}class dk extends Lo{constructor(e,t,r){super(),this.Du=e,this.cacheSizeBytes=t,this.forceOwnership=r,this.kind="persistent",this.synchronizeTabs=!1}async initialize(e){await super.initialize(e),await this.Du.initialize(this,e),await mI(this.Du.syncEngine),await Zo(this.Du.remoteStore),await this.persistence.Ji(()=>(this.gcScheduler&&!this.gcScheduler.started&&this.gcScheduler.start(),this.indexBackfillerScheduler&&!this.indexBackfillerScheduler.started&&this.indexBackfillerScheduler.start(),Promise.resolve()))}wu(e){return Qw(this.persistence,new Ww,e.initialUser,this.serializer)}Su(e,t){const r=this.persistence.referenceDelegate.garbageCollector;return new qw(r,e.asyncQueue,t)}bu(e,t){const r=new gC(t,this.persistence);return new mC(e.asyncQueue,r)}yu(e){const t=c1(e.databaseInfo.databaseId,e.databaseInfo.persistenceKey),r=this.cacheSizeBytes!==void 0?ht.withCacheSize(this.cacheSizeBytes):ht.DEFAULT;return new Ad(this.synchronizeTabs,t,e.clientId,r,e.asyncQueue,b1(),Za(),this.serializer,this.sharedClientState,!!this.forceOwnership)}pu(e){return new Xw}}class Ml{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Ig(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=ck.bind(null,this.syncEngine),await $1(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return function(){return new q1}()}createDatastore(e){const t=yc(e.databaseInfo.databaseId),r=function(i){return new E1(i)}(e.databaseInfo);return function(i,o,l,c){return new P1(i,o,l,c)}(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return function(r,s,i,o,l){return new x1(r,s,i,o,l)}(this.localStore,this.datastore,e.asyncQueue,t=>Ig(this.syncEngine,t,0),function(){return mg.C()?new mg:new v1}())}createSyncEngine(e,t){return function(s,i,o,l,c,u,d){const p=new X1(s,i,o,l,c,u);return d&&(p.Au=!0),p}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await async function(s){const i=he(s);$(fs,"RemoteStore shutting down."),i.Ta.add(5),await Xo(i),i.Ea.shutdown(),i.da.set("Unknown")}(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}Ml.provider={build:()=>new Ml};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fk{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.vu(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.vu(this.observer.error,e):Tt("Uncaught Error in snapshot listener:",e.toString()))}Cu(){this.muted=!0}vu(e,t){setTimeout(()=>{this.muted||e(t)},0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ok(n,e,t){let r;return r=n?n.toFirestore(e):e,r}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
